...
class ContextBuilder:
    ...
    def _get_conversation_history(self, conversation_id: int) -> List[Dict[str, Any]]:
        ...
        conversation = self.user_profile_service.db.query(Conversation).filter(Conversation.id == conversation_id).first()
    ...
    def _format_context(
        ...
        context = "You are a helpful assistant that learns from user interactions. "
        context += "You should tailor your responses based on the user's history and preferences. "
